...
class TopKEvaluator(GroupedEvaluator):
    ...
    def collect(self, interaction, scores_tensor):
       ...
       """
        ...
        #print("score_matrix$$$$$$$$$$$$$:", scores_matrix)
        scores_matrix = torch.flip(scores_matrix, dims=[-1])
        #print("score_matrix_flip$$$$$$$$$$$$$:", scores_matrix)
    ...
    def evaluate(self, batch_matrix_list, eval_data):
        ...
        #print("batch_matrix!!!!!!!!:", batch_matrix_list)
        ...
        #print("pos_len:", len(pos_len_list))
        #print("topk:", len(topk_idx))
        ...
        for metric, value in zip(self.metrics, result_list):
            for k in self.topk:
                key = '{}@{}'.format(metric, k)
                metric_dict[key] = round(value[k - 1], self.precision) #self.precision = 4
